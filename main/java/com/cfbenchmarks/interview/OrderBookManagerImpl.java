...
public class OrderBookManagerImpl implements OrderBookManager {
  ...
  private Map<String, OrderBook> m_ordersByInstrumentSide = Collections.synchronizedMap( new HashMap<String, OrderBook>() );
  ...
  public boolean modifyOrder(String orderId, long newQuantity) {
    ...
    return getOrderBook( order.getInstrument(), order.getSide() ).modify( order, newQuantity );
  }

  /**
   * TODO can I break this sync between order books and order by id
   */
