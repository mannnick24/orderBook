...
public class DataValidationTest {
  ...
  public void orderBuilder() {
    Order order = new Order.Builder().setInstrument("test").setOrderId("order1").setSide(Side.BUY).setPrice(200)
        .setQuantity(10).get();
  ...
  public void orderBuilderImmutable() {
    Order.Builder orderBuilder = new Order.Builder().setInstrument("test").setOrderId("order1").setSide(Side.BUY)
        .setPrice(200).setQuantity(10);

    Order firstOrder = orderBuilder.get();

    // now modify via the builder
    orderBuilder.setInstrument("sddsfsdf").setOrderId("sdfdsfsdf").setSide(Side.SELL).setPrice(2).setQuantity(1);
  ...
  public void cloneOrder() {
    Order firstOrder = new Order.Builder().setInstrument("test").setOrderId("order1").setSide(Side.BUY).setPrice(200)
        .setQuantity(10).get();

    // clone and modify
    Order secondOrder = new Order.Builder().clone(firstOrder).setPrice(2).setQuantity(1).get();
  ...
  public void nullOrderArguments() {
    ...
    assertThrows(IllegalArgumentException.class, () -> {
      new Order.Builder().setInstrument(null).setOrderId("order1").setSide(Side.BUY).setPrice(200).setQuantity(10)
          .get();
    });

    // orderId can't be null
    assertThrows(IllegalArgumentException.class, () -> {
      new Order.Builder().setInstrument("guitar").setOrderId(null).setSide(Side.BUY).setPrice(200).setQuantity(10)
          .get();
    });

    // side can't be null
    assertThrows(IllegalArgumentException.class, () -> {
      new Order.Builder().setInstrument("guitar").setOrderId("order1").setSide(null).setPrice(200).setQuantity(10)
          .get();
    });
  }
  ...
  public void incorrectOrderArguments() {
    ...
    assertThrows(IllegalArgumentException.class, () -> {
      new Order.Builder().setInstrument("").setOrderId("order1").setSide(Side.BUY).setPrice(200).setQuantity(10).get();
    });

    // orderId can't be blank
    assertThrows(IllegalArgumentException.class, () -> {
      new Order.Builder().setInstrument("fake").setOrderId("").setSide(Side.BUY).setPrice(200).setQuantity(10).get();
    });

    // price must be positive
    assertThrows(IllegalArgumentException.class, () -> {
      new Order.Builder().setInstrument("fake").setOrderId("e").setSide(Side.BUY).setPrice(-1).setQuantity(10).get();
    });

    // qty must be positive
    assertThrows(IllegalArgumentException.class, () -> {
      new Order.Builder().setInstrument("fake").setOrderId("e").setSide(Side.BUY).setPrice(33).setQuantity(-1).get();
    });

    // instrument can't have ::
    assertThrows(IllegalArgumentException.class, () -> {
      new Order.Builder().setInstrument("fake::bad").setOrderId("e").setSide(Side.BUY).setPrice(33).setQuantity(10)
          .get();
    });
  }
  ...
  public void nullApiArguments() {
    ...
    // create order
    Order order = new Order.Builder().setInstrument("blast").setOrderId("order1").setSide(Side.BUY).setPrice(200)
        .setQuantity(10).get();
    // send order
  ...
  public void incorrectApiArguments() {
    ...
    // create order
    Order order = new Order.Builder().setInstrument("DXYP").setOrderId("order1").setSide(Side.BUY).setPrice(200)
        .setQuantity(10).get();
    // send order
    orderBookManager.addOrder(order);
  ...
  public void existingAndMissing() {
    ...
    /* can't add existing */
    assertThrows(IllegalArgumentException.class, () -> {
      Order duplicateOrderId = new Order.Builder().setInstrument("DXYPY").setOrderId("order1").setSide(Side.SELL)
          .setPrice(44).setQuantity(33).get();
      // send order
