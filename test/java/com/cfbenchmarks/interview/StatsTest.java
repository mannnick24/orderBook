...
public class StatsTest {
  ...
  public void noBook() {
    ...
    assertEquals("Empty book should return empty best price", Optional.empty(),
        orderBookManager.getBestPrice("VOD.L", Side.BUY));
    assertEquals("Empty book should return empty best price", Optional.empty(),
        orderBookManager.getBestPrice("VOD.L", Side.SELL));
  ...
  public void missingOrderLevel() {
    ...
    OrderBookManager orderBookManager = new OrderBookManagerImpl();
    // create order at 200
    Order buy = new Order.Builder().setOrderId("order1").setInstrument("VOD.L").setSide(Side.BUY).setPrice(200)
        .setQuantity(10).get();
